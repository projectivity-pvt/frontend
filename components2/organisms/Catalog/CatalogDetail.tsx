        ...
        <div className='w-72 bg-gray-100 p-4 rounded'>
            ...
            <div className='flex flex-col gap-5'>
                ...
                <div className='flex justify-center'>
                    <Image src="/images/catalog/camera_catalog.png" height={50} width={80} />
                </div>
                ...
                <div className='flex justify-between items-center text-xs'>
                    <input className='border-gray-300 h-8 w-32 rounded text-xs' type="number" />
                    <button className='bg-blue-600 text-white text-xs rounded-2xl py-1 px-2'>Updated Price</button>
                </div>
            </div>
