...
export const VendorProjectCard = () => (
  <div className="group rounded-xl border p-2 max-w-xs">
    ...
    <div className="mt-5">
      <div className="due bg-red-100 py-1 px-2 inline-block rounded text-red-600 text-xs">
        Due Date: 23 Nov, 2021
      </div>
      <Badge className="bg-gray-200 text-gray-600 font-bold py-1 px-3 ml-2 rounded">2</Badge>
    </div>
