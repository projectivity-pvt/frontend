...
export const ProductProjectListItem = () => (
    <>
        <div className="p-3 rounded-lg flex justify-between items-center mt-2 mx-5" style={{ background: "#F5F5F5" }}>
            <div className="avatar rounded-full text-white flex items-center justify-center h-8 w-8 md:h-8 md:w-8 mr-2 md:mr-5" style={{ backgroundColor: '#FFC7A7' }}>
                A
            </div>
            <div>
