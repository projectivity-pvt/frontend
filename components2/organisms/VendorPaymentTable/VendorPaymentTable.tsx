      ...
      <Table>
        <TableHeader>
          <TableRow style={{ background: '#fff', border: '1px solid #fff' }}>
            <TableCell>
              <div className="py-2 text-sm font-normal capitalize w-64">
                Project Name
              </div>
            </TableCell>
            <TableCell>
            ...
            <TableCell>
              <div className="py-2 text-sm font-normal capitalize">Invoice</div>
            </TableCell>
            <TableCell>
              <div className="py-2 text-sm font-normal capitalize">Action</div>
            </TableCell>
          </TableRow>
        </TableHeader>
        <TableBody>
          <Link href="/vendor/contracts">
            <TableRow className="" style={{ background: '#fff' }}>
              <TableCell>
                <p className="w-64 truncate text-sm text-black py-3">
                  Burger Singh Ad shoot
                </p>
              </TableCell>
              <TableCell>
                <div className="text-gray-500 text-sm">30 Nov, 2021</div>
              </TableCell>
              <TableCell>
