...
export const UserPill = () => {
  ...
  return (
    ...
    <div className="group py-1 pl-2 pr-5 rounded-full bg-white flex gap-2 items-center shadow-md cursor-pointer">
      <Image src="/images/user_prabhas.jpg" height={40} width={40} className="rounded-full" />
      <h5 className="truncate w-20">{ users && users.userData && users.userData.name ? users.userData.name : 'John Doe'}</h5>
