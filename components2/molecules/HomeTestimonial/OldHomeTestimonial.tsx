...
export const HomeTestimonial = () => (
    <div>
        <section className="flex items-center justify-center py-20 bg-white min-w-screen">
            <div className="px-3 md:px-16 bg-white">
                <div className="container flex flex-col items-start mx-auto lg:items-center">
                    <p className="relative flex items-start justify-start w-full text-lg font-bold tracking-wider text-indigo-600 uppercase lg:justify-center lg:items-center">
                    ...
                    <div className="block w-full h-0.5 max-w-lg mt-6 bg-indigo-100 rounded-full" />
                    <div className="items-center justify-center w-full mt-12 mb-4 lg:flex">
                        <div className="flex flex-col items-start justify-start w-full h-auto mb-12 lg:w-1/3 lg:mb-0">
                            <div className="flex items-center justify-center">
                                ...
                                <div className="flex flex-col items-start justify-center">
                                    ...
                                    <p className="text-gray-600">CEO of Dharma Productions</p>
                                </div>
                            </div>
                        ...
                        <div className="flex flex-col items-start justify-start w-full h-auto px-0 mx-0 mb-12 border-l border-r border-transparent lg:w-1/3 lg:mb-0 lg:px-8 lg:mx-8 lg:border-gray-200">
                            <div className="flex items-center justify-center">
                                ...
                                <div className="flex flex-col items-start justify-center">
                                    ...
                                    <p className="text-gray-600">Camera Vendor</p>
                                </div>
                            </div>
                            <blockquote className="mt-8 text-lg text-gray-500">
                        ...
                        <div className="flex flex-col items-start justify-start w-full h-auto lg:w-1/3">
                            <div className="flex items-center justify-center">
                                <div className="w-16 h-16 mr-4 overflow-hidden bg-gray-200 rounded-full">
                                    <img
                                        src="https://www.xtrafondos.com/wallpapers/fortnite-john-wick-3104.jpg"
                                        className="object-cover w-full h-full"
                                    />
                                </div>
                                <div className="flex flex-col items-start justify-center">
                                    <h4 className="font-bold text-gray-800">John Wick</h4>
                                    <p className="text-gray-600">Fortis Fortuna Adiuvat</p>
                                </div>
                            </div>
                            <blockquote className="mt-8 text-lg text-gray-500">
