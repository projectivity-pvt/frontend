...
import { User, userGlobalState, userTokenGlobalState, UserType } from './UserGlobalState'
...
export const setUserTokenGlobalState = (token: string | null) => {
  userTokenGlobalState({
    token ,
  })
}
