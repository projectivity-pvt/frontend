...
export const ContactPopup = ({ closeModal2 }) => (
  <>
    <div
    ...
    >
      <div className="pl-5 -mt-5 mb-5">
        <div className="flex justify-between items-center">
          ...
          <div>
            <h4 onClick={() => closeModal2(false)} className="flex justify-center items-center p-4 bg-red-100 w-5 h-5 rounded-full cursor-pointer">
              <FontAwesomeIcon
          ...
          <div className="pl-10 mt-5">
            <div>
              ...
              <button className="rounded-3xl text-xs bg-gray-300 py-2 px-5 mt-2">
                Non Disclosure Certificate.pdf
              </button>
            </div>
