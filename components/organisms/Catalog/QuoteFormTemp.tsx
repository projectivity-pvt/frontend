        ...
        <div className='bg-white p-5 rounded-lg quotation_wrapper'>
            ...
            <form>
                ...
                <div className='flex justify-between'>
                    ...
                    <div>
                        <button className='w-32 text-xs text-white bg-green-500 rounded-3xl py-2 px-5'>Submit</button>
                    </div>
                </div>

                <div className='flex flex-wrap justify-center md:justify-between items-center border-top mt-10'>
                    <div>
                        <p className='text-gray-500 text-xs'>You can track the status in the chat section.</p>
                    </div>
                    <div className='flex gap-5 mt-5 md:mt-0'>
                        <button className='w-32 text-xs text-red-600 bg-gray-200 rounded-3xl py-2 px-5'>Decline</button>
                        <button className='w-32 text-xs text-white bg-blue-600 rounded-3xl py-2 px-5'>Send Message</button>
                    </div>
                </div>
