...
export const BusinessCallTime = () => {
  ...
  const [openAddTimecardModal, setOpenAddTimecardModal] = useState(false)

  return (
    <>
      {openAddTimecardModal && (
        <div className="pop_container" style={{ alignItems: 'center' }}>
          <div className="w-3/5">
            <AddTimeCard closeModal8={setOpenAddTimecardModal} />
            <p className="h-5"></p>
          </div>
        </div>
      )}
        ...
        <main className="">
          <div className="card">
            ...
            <div className="flex justify-end -mt-10">
              <button
                onClick={() => setOpenAddTimecardModal(true)}
                className="flex items-center gap-2 bg-blue-500 text-white rounded-full text-xs px-10 py-2.5 hover:bg-blue-600"
              >
                <FontAwesomeIcon
          ...
          <div className="card">
            <div className="flex justify-between items-bottom">
              ...
              <div className="flex flex-col gap-3">
                <div className="flex items-center gap-5">
                  <p className="text-green-500 py-1 bg-green-100 rounded-2xl border border-green-200 w-32 text-xs text-center">
                    18 Selected
                  </p>
                  <button className="text-xs bg-blue-600 text-white rounded-2xl py-1.5 w-36">
                    Initiate Check OUT
                  </button>
                </div>
                <div className="flex items-center gap-5">
                ...
                <div className="flex items-center gap-5">
                  <p className="border-gray-300 border py-1 rounded-2xl w-32 text-xs text-center">
                    Select All
                  </p>
                  <button className="text-xs bg-gray-300 text-white rounded-2xl py-1.5 w-36">
                    Initiate Check OUT
                  </button>
                </div>
              </div>
            ...
            <div className="mt-10">
              <div
                className={
                  checkinTable
                    ? 'border-gray-300 border rounded py-3 px-2'
                    : 'text-white border-gray-300 border rounded py-3 px-2 bg-red-500'
                }
              ...
              <div
                className={
                  checkinTable
                    ? 'vendor_checkin_table'
                    : 'vendor_checkin_table_active'
                }
              >
                <VendorContractsChekinTable />
              </div>
