...
export const BusinessSinglePaidTemplate = () => {
            ...
            <div className="col-span-8">
              <div className="card">
                ...
                <div className="mb-10">
                  ...
                  <div className="bg-green-100 w-full rounded-lg py-3 px-5">
                    <div className="flex justify-between align-center">
                      <p className="text-gray-700 text-sm p-2">
                        You have received a payment of $4567 .
                      </p>
                      <button className="rounded-3xl py-1 px-5 text-xs bg-green-500 hover:bg-green-400 text-white">
                        {' '}
                        Contact support{' '}
                      </button>
                    </div>
                ...
                <div className="w-full">
                  <div className="flex gap-5 justify-end">
                    <button
                      className="bg-gray-200 hover:bg-gray-300 rounded-3xl text-sm px-5 py-2 w-36"
                      onClick={() => {
                    ...
                    <button className="bg-yellow-300 hover:bg-yellow-200 rounded-3xl text-sm px-5 py-2 w-36">
                      Print As PDF
                    </button>
                  </div>
                  <VendorPaidTemp />
                ...
                <div className="mb-10">
                  ...
                  <div className="bg-green-100 w-full rounded-lg py-3 px-5">
                    <div className="flex justify-between align-center">
                      <p className="text-gray-700 text-sm p-2">
                        You have generated the invoice.
                      </p>
                      <button className="rounded-3xl py-1 px-5 text-xs bg-green-500 hover:bg-green-400 text-white">
                        {' '}
                        Invoice Generated{' '}
                ...
                <div className="w-full">
                  <div className="flex gap-5 my-2 justify-end">
                    <button
                      className="bg-gray-200 hover:bg-gray-300 rounded-3xl text-sm px-5 py-2 w-36"
                      onClick={() => {
                        setOpenModal(true)
