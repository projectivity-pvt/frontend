            ...
            <div className="flex flex-col flex-1 overflow-y-auto ">
                ...
                <main className="">
                    ...
                    <div className="mb-10">
                        ...
                        <div className="bg-green-100 w-full md:w-3/5 rounded-lg p-5">
                            <p className="text-gray-700 text-xs p-2">You can now generate the invoice by adding you GST Number.</p>
                            <div className="flex md:flex-row flex-col justify-between align-center">
                                <input className="rounded w-full md:w-3/5 border-gray-200 text-xs" type="text" placeholder="GST Number" />
                                <button className="mt-5 md:mt-0 rounded-3xl py-2.5 md:py-1 px-5 text-xs bg-green-500 text-white">Generate Invoice</button>
                            </div>
                        </div>
                    </div>
